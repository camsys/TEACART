...
"),
      ...
      nav_panel(title = "How-to",
                ...
                tags$ol(
                  ...
                  tags$img(src = '100.svg', style = "width: 70%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '200.svg', style = "width: 100%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '250.svg', style = "width: 80%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '275.svg', style = "width: 100%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  tags$li(HTML("In the Budget tab, data can be entered the same way. Double click values to begin entering.<br><p>")),
                  tags$img(src = '300.svg', style = "width: 80%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  tags$li(HTML("When you are done entering data, press CTRL + ENTER on your keyboard (this initiates the calculation). Data can only be entered for one table at a time.<br><p>")),
                  tags$img(src = '400.svg', style = "width: 100%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  tags$li(HTML("When entering <b>Budget</b> values, you must also update the Projects before beginning the calculation.<br><p>")),
                  tags$img(src = '450.svg', style = "width: 100%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  tags$li(HTML("Or, if you want to view updates to Budget values based on your <b>Projects</b>, you must update the Budget values.<br><p>")),
                  tags$img(src = '475.svg', style = "width: 100%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '500.svg', style = "width: 30%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '600.svg', style = "width: 80%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '700.svg', style = "width: 80%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  tags$li(HTML("Click the boxes to choose which groups of projects to include in the Scenario analysis.<br><p>")),
                  tags$img(src = '800.svg', style = "width: 100%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
                  ...
                  tags$img(src = '900.svg', style = "width: 80%; max-width: intrinsic; height: auto;"),
                  HTML("<br><br>"),
...
#                  tags$img(src = 'about_step_11.png'),
                  ...
                  tags$img(src = '1000.svg', style = "width: 30%; max-width: intrinsic; height: auto;"),
                )
      ),
